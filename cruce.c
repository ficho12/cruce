...
int main (int argc, char *argv[]){
	...
	*/
	...
	if(datos.memid==-1){
		...
		kill(getpid(),SIGTERM);							//Llamar manejador
	}
			...
			case 0:
				...
				if(pos1.y==10)			//C2
				{
					do{ 
						...
						if(flag2==1 && flagCruce<6){ //Libera x=33 y=10 //flagCruce estaba a <8
